...
onMounted(() => {
  /* better way here is to use css hover and transitions, but I have tried GSAP for the hover animation */
...
<template>
  <div
    class="p-8 pr-12 w-[60vw] h-full flex flex-col overflow-hidden"
